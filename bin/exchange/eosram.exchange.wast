(module
 ...
 (data (i32.const 1280) "RAM token exchange is stopped!\00")
 (data (i32.const 1312) "Order doesn\'t exists\00")
 (data (i32.const 1344) "Order doesn\'t exist\00")
 (data (i32.const 1376) "multiplication overflow or underflow\00")
 (data (i32.const 1424) "multiplication underflow\00")
 ...
 (data (i32.const 1664) "Cancel order fee\00")
 (data (i32.const 1696) "Order was canceled\00")
 (data (i32.const 1728) "handle_expired_order: Order has not expired!\00")
 (data (i32.const 1776) "eosio\00")
 (data (i32.const 1792) "RAM token issuance fee\00")
 (data (i32.const 1824) "Burn RAM token fee\00")
 (data (i32.const 1856) "ram_market::get_ramprice: Could not calculate valid RAM price!\00")
 (data (i32.const 1920) "Issuing RAM token: \00")
 (data (i32.const 1952) "issue\00")
 (data (i32.const 1968) ".\00")
 (data (i32.const 1984) " \00")
 (data (i32.const 2000) "ram_market: Could not find eosiosystem rammarket!\00")
 (data (i32.const 2064) "Token transfer fee\00")
 (data (i32.const 2096) " tokens @\00")
 (data (i32.const 2112) "/KiB\00")
 (data (i32.const 2128) "Bought \00")
 (data (i32.const 2144) "Sold \00")
 (data (i32.const 2160) "Burning RAM token: \00")
 (data (i32.const 2192) "burn\00")
 (data (i32.const 2208) "cannot pass end iterator to erase\00")
 (data (i32.const 2256) "cannot increment end iterator\00")
 (data (i32.const 2288) "Queue element was not erased properly!\00")
 (data (i32.const 2336) "object passed to erase is not in multi_index\00")
 (data (i32.const 2384) "cannot erase objects in table of another contract\00")
 (data (i32.const 2448) "attempt to remove object that was not in multi_index\00")
 (data (i32.const 2512) "execute_order\00")
 (data (i32.const 2528) "Order has expired\00")
 (data (i32.const 2560) "Cannot modify index_queue element, invalid iterator!\00")
 (data (i32.const 2624) "Can\'t compare amount of different assets\00")
 (data (i32.const 2672) "Trade fee\00")
 (data (i32.const 2688) "The value must be in EOS or RAM!\00")
 (data (i32.const 2736) "Trade value does not satisfy min trade amount!\00")
 (data (i32.const 2784) "Invlid ttl!\00")
 (data (i32.const 2800) "Cannot push element to queue, seq is at max limit\00")
 ...
 (data (i32.const 2976) "get_txid: read_transaction failed!\00")
 (data (i32.const 3024) "Returning excesed amount\00")
 (data (i32.const 3056) "Invalid action call!\00")
 (data (i32.const 3088) "onerror action\'s are only valid from the \"eosio\" system account\00")
 (data (i32.const 3152) "get\00")
 (data (i32.const 3168) "on_order_expired: Order does not exists!\00")
 (data (i32.const 3216) "eosio.ram\00")
 (data (i32.const 3232) "Invalid quantity in transfer\00")
 (data (i32.const 3264) "Transferred quantity must be positive value\00")
 (data (i32.const 3312) "memo_cmd_cancel_order: Invalid transaction id!\00")
 (data (i32.const 3360) "Invalid hex character!\00")
 (data (i32.const 3392) "Invalid hex string\00")
 (data (i32.const 3424) "Invalid number\00")
 (data (i32.const 3440) "memo_cmd_make_order: Invalid memo!\00")
 (data (i32.const 3488) "memo_cmd_make_order: Invalid arg delim!\00")
 (data (i32.const 3536) "memo_cmd_make_order: Invalid argument!\00")
 (data (i32.const 3584) "memo_parser: memo has more than 256 bytes\00")
 (data (i32.const 3632) "cancel\00")
 (data (i32.const 3648) ":\00")
 (data (i32.const 3664) "memo_parser: Invalid arg delimiter!\00")
 (data (i32.const 3712) "owner\00")
 (data (i32.const 3728) "admin\00")
 (data (i32.const 3744) "clrorders\00")
 (data (i32.const 3760) "onerror\00")
 (data (i32.const 12176) "malloc_from_freed was designed to only be called after _heap was completely allocated\00")
 (data (i32.const 12272) "\00\00\00\00\00\00\f0?\00\00\00\00\00\00\f8?")
 (data (i32.const 12288) "\00\00\00\00\00\00\00\00\06\d0\cfC\eb\fdL>")
 (data (i32.const 12304) "\00\00\00\00\00\00\00\00\00\00\00@\03\b8\e2?")
 ...
 (export "_ZN6eosram8exchange24deferred_order_executionEymy" (func $_ZN6eosram8exchange24deferred_order_executionEymy))
 ...
 (func $_ZN6eosram8exchange24deferred_order_executionEymy (param $0 i32) (param $1 i64) (param $2 i32) (param $3 i64)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
   ...
   (block $label$2
    (block $label$3
     ...
     (block $label$42
      ...
      (call $_ZN6eosram8exchange24deferred_order_executionEymy
       (get_local $0)
       (i64.load
        (i32.add
         (i32.add
 ...
 (func $_ZN5eosio14memory_manager16next_active_heapEv (param $0 i32) (result i32)
  ...
  (block $label$0
   (block $label$1
    (br_if $label$1
     (i32.eqz
      (i32.load8_u offset=12262
       (i32.const 0)
      )
     )
    )
    (set_local $7
     (i32.load offset=12264
      (i32.const 0)
     )
    )
    (br $label$0)
