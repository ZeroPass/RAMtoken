(module
 ...
 (table 7 7 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN8exchange11ramexchange3buyEyN5eosio5assetEmb $_ZN8exchange11ramexchange9getvolumeEv $_ZN8exchange11ramexchange4sellEmb $_ZN8exchange11ramexchange8withdrawEv $_ZN8exchange11ramexchange10dotransferEv $_ZN8exchange11ramexchange8getvalueEv)
 (memory $0 1)
 ...
 (data (i32.const 224) "Contract address cannot buy.\00")
 (data (i32.const 256) "Invalid symbol name\00")
 (data (i32.const 288) "Unvalid quantity.\00")
 (data (i32.const 320) "EOS quaninty must be positive.\00")
 (data (i32.const 352) "give me the money\00")
 ...
 (data (i32.const 464) "The value must be in EOS.\00")
 ...
 (export "_ZN8exchange11ramexchange4sellEmb" (func $_ZN8exchange11ramexchange4sellEmb))
 (export "_ZN8exchange11ramexchange8getvalueEv" (func $_ZN8exchange11ramexchange8getvalueEv))
 (export "_ZN8exchange11ramexchange8withdrawEv" (func $_ZN8exchange11ramexchange8withdrawEv))
    ...
    (block $label$22
     (block $label$23
      (block $label$24
       ...
       (drop
        (call $_ZN5eosio14execute_actionIN8exchange11ramexchangeES2_JmbEEEbPT_MT0_FvDpT1_E
         (i32.add
          (get_local $12)
          (i32.const 104)
         )
 ...
 (func $_ZN8exchange11ramexchange4sellEmb (type $FUNCSIG$viii) (param $0 i32) (param $1 i32) (param $2 i32)
 )
 (func $_ZN5eosio14execute_actionIN8exchange11ramexchangeES2_JmbEEEbPT_MT0_FvDpT1_E (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $_ZN8exchange11ramexchange8withdrawEv (type $FUNCSIG$vi) (param $0 i32)
 )
